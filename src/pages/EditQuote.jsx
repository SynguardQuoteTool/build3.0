...
export default function EditQuote() {
  ...
  // Use default country from the quote or default to UK
  const country = originalQuote?.country || "UK";
  const currency = originalQuote?.currency || systemSettings?.currency || "£";
  ...
  const handleSaveQuote = () => {
    ...
    const updatedQuoteObject = {
      ...
      client: originalQuote.client || "N/A", // Keep the original client value
      date: new Date().toISOString().slice(0, 10),
      notes: "",
      updated: timestamp,
      totalDiscount: totalDiscount.toFixed(2),
      country: originalQuote.country || "UK", // Keep the original country value
    };
    ...
    try {
      ...
      // Add a timeout to ensure state updates are processed
      setTimeout(() => {
        const result = updateQuote(updatedQuoteObject);
          ...
          return (
            <>
              ...
              <div style={{ marginBottom: "15px", fontSize: "10pt" }}>
                ...
                {originalQuote.client || "Customer"}<br />
